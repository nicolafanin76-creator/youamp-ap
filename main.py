...
BANCA_DATI_EXTRA_SORGENTE = {
    ...
    "Pandoro": {"Kcal": 410, "info": "fetta 100g"},
...
# Costruzione della tabella HTML dinamica bianca
html_tabella = f"""
<table class="quadro-tabella">
    ...
    <tbody>
        <tr class="{'riga-attiva' if giorno_workout else ''}">
            ...
            <td>{pt_kcal_wo} Kcal</td>
            <td>{spesa_prevista_wo} Kcal</td>
            <td>{round(st.session_state.cal_generate_wo)} Kcal</td>
            <td>{round(deficit_wo)} Kcal</td>
        </tr>
        <tr class="{'riga-attiva' if not giorno_workout else ''}">
            ...
            <td>{pt_kcal_rest} Kcal</td>
            <td>{spesa_prevista_rest} Kcal</td>
            <td>{round(st.session_state.cal_generate_rest)} Kcal</td>
            <td>{round(deficit_rest)} Kcal</td>
        </tr>
    </tbody>
</table>
"""
...
# Monitorification Idratazione Dinamica Centrata
